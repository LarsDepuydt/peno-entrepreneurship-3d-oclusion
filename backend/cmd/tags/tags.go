...
func GetTagById(req *connect.Request[threedoclusionv1.GetTagRequest]) (*connect.Response[threedoclusionv1.TagResponse], error) {
	log.Println("Request headers: ", req.Header())
	res := connect.NewResponse(&threedoclusionv1.GetTagResponse{
		Id:    req.Msg.Id,
		Color: "black",
		Text:  "test",
	})
