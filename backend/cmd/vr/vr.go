...
func GetPositionScanByID(req *connect.Request[threedoclusionv1.GetPositionScanRequest],
...
func SendPositionScanByID(req *connect.Request[threedoclusionv1.SendPositionScanRequest],
