            ...
            {!showListView ? (
              <div className={stylesVR.menu_content}>
                <div className={stylesVR.menu_header}>
                  ...
                  <div className={stylesVR.menu_close} onClick={toggleMenu}>
                    &times;
                  </div>
                </div>
                <ul className={stylesVR.menu_options}>
                  <button className={stylesVR.menu_option} onClick={load}>Load</button>
                  <button className={stylesVR.menu_option} onClick={save}>Save manually</button>
                  <button className={stylesVR.menu_option} onClick={saveAndQuit}>Save and quit</button>
                  <button className={stylesVR.menu_option} onClick={quit}>Quit</button>
                  <button className={stylesVR.menu_option} onClick={reset}>Reset</button>
                </ul>
              </div>
            ):(
