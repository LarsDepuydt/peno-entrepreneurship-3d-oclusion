...
/**
 * @generated from rpc threedoclusion.v1.ScanService.GetLastSaveData
 */
export const getLastSaveData = createQueryService({
  service: {
    methods: {
      getLastSaveData: {
        name: "GetLastSaveData",
        kind: MethodKind.Unary,
        I: GetLastSaveDataRequest,
        O: GetLastSaveDataResponse,
      },
    },
    typeName: "threedoclusion.v1.ScanService",
  },
