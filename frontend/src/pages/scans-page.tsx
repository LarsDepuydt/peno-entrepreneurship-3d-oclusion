...
const all_scans = [
  {
    scan11: <Scan scanid={1} patientid={1} picture={teeth3d} date={new Date(2023, 2, 21).toISOString()} />,
    scan12: <Scan scanid={1} patientid={2} picture={teeth3d} date={new Date(2023, 2, 20).toISOString()} />,
    scan13: <Scan scanid={1} patientid={3} picture={teeth3d} date={new Date(2023, 1, 10).toISOString()} />,
  },

  {
    scan21: <Scan scanid={1} patientid={4} picture={teeth3d} date={new Date(2022, 4, 4).toISOString()} />,

    scan22: <Scan scanid={1} patientid={5} picture={teeth3d} date={new Date(2023, 3, 1).toISOString()} />,

    scan23: <Scan scanid={1} patientid={6} picture={teeth3d} date={new Date(2022, 12, 23).toISOString()} />,
  },
  {
    scan31: <Scan scanid={1} patientid={7} picture={teeth3d} date={new Date(2023, 2, 19).toISOString()} />,
    scan32: <Scan scanid={1} patientid={8} picture={teeth3d} date={new Date(2023, 3, 21).toISOString()} />,

    scan33: <Scan scanid={1} patientid={9} picture={teeth3d} date={new Date(2022, 11, 7).toISOString()} />,
  },

  {
    scan41: <Scan scanid={1} patientid={10} picture={teeth3d} date={new Date(2022, 12, 7).toISOString()} />,

    scan42: <Scan scanid={2} patientid={10} picture={teeth3d} date={new Date(2022, 12, 6).toISOString()} />,

    scan43: <Scan scanid={2} patientid={8} picture={teeth3d} date={new Date(2023, 2, 21).toISOString()} />,
  },
];
