...
async function asyncOgSepAxis(hullB, posA, quatA, posB, quatB, target, faceListA, faceListB) {
    const faceANormalWS3 = new CANNON.Vec3();
    const Worldnormal1 = new CANNON.Vec3();
    const deltaC = new CANNON.Vec3();
    const worldEdge0 = new CANNON.Vec3();
...
// the original findSeparatingAxis function, but without checking the edge collisions
function ogSepAxisNoEdges(hullB, posA, quatA, posB, quatB, target, faceListA, faceListB) {
    const faceANormalWS3 = new CANNON.Vec3();
    const Worldnormal1 = new CANNON.Vec3();
    const deltaC = new CANNON.Vec3();
    const worldEdge0 = new CANNON.Vec3();
...
export { findSepAxis, findSepAxisOverload, asyncOgSepAxis, ogSepAxisNoEdges };