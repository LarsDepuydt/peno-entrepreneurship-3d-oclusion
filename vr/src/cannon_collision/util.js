...
function threeMeshToConvexCannonMesh(mesh) {
    return threeGeometryToConvexCannonMesh(mesh.geometry);
}
...
export { getFirstMesh, getFirstBufferGeometry, threeMeshToConvexThreeMesh, threeMeshToConvexCannonMesh, cannonMeshToCannonConvexPolyhedron, threeMeshToCannonMesh, threeGeometryToConvexCannonMesh, checkTime, vector3ToVec3, vec3ToVector3, threeQuaternionToCannonQuaternion, applyQuaternion, sqnorm, quatDot, minusQuat };